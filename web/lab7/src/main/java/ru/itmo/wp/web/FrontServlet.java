...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method before = findMethod("before", pageClass);
        ...
        invokeMethod(before, request, view, page, pageClass);
    ...
    private void invokeMethod(Method method, HttpServletRequest request, Map<String, Object> view,
                              Object page, Class<?> pageClass) throws ServletException {
        try {
            method.setAccessible(true);
    ...
    private Method findMethod(String methodName, Class<?> pageClass) throws NotFoundException {
