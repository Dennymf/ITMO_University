...
public class FrontServlet extends HttpServlet {
    ...
    Method getMethod(Class<?> pageClass, Route route, String name) {
        Method method = null;
    ...
    private void process(Route route,
        ...
        Method method = getMethod(pageClass, route, null);

        if (method == null) {
            throw new NotFoundException();
        }
        Method beforeMethod = getMethod(pageClass, null, "before");
        Method afterMethod = getMethod(pageClass, null, "after");
